...
export default function AnalisiComponent() {
    return (
            ...
            <Container>
                <Row className='flex-wrap mx-1'>
                    <Col xs={12} md={4}>
                        <Row>
                            <Col xs={1}  className='d-flex justify-content-center align-items-start p-0 pt-1'>
                                <IoPeopleSharp className='fs-5'/>
                            </Col>
                            <Col xs={11} >
                                <p className='fw-semibold m-0 fs-5'>37 visualizzazioni del profilo</p>
                    ...
                    <Col xs={12} md={4}>
                        <Row>
                            <Col xs={1}  className='d-flex justify-content-center align-items-start p-0 pt-1'>
                                <MdOutlineBarChart className='fs-5'/>
                            </Col>
                            <Col xs={10}>
                                <p className='fw-semibold m-0 fs-5'>72 impressioni del post</p>
                    ...
                    <Col xs={12} md={4}>
                        <Row>
                            ...
                            <Col xs={10}>
                                <p className='fw-semibold m-0 fs-5'>4 comparse nei motori di ricerca</p>
        ...
        <p className='text-center text-secondary fw-semibold my-2 fs-5 d-flex justify-content-center align-items-center'>Mostra tutte le analisi <FaArrowRightLong className='fs-5 ms-2' /></p>
        </div>
    )
}
